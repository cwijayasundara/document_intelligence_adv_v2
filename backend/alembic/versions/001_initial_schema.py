...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.String(20), nullable=False,
                  server_default=sa.text("'uploaded'"), index=True),
        sa.Column("document_category_id", UUID(as_uuid=True),
                  sa.ForeignKey("document_categories.id"), nullable=True, index=True),
    ...
    op.create_table(
        ...
        sa.Column("category_id", UUID(as_uuid=True),
                  sa.ForeignKey("document_categories.id"), nullable=False, index=True),
        sa.Column("version", sa.Integer(), nullable=False, server_default=sa.text("1")),
        sa.Column("schema_yaml", sa.Text(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False,
                  server_default=sa.text("NOW()")),
        sa.UniqueConstraint("category_id", "version",
                            name="uq_extraction_schemas_category_version"),
    )
    ...
    op.create_table(
        ...
        sa.Column("schema_id", UUID(as_uuid=True),
                  sa.ForeignKey("extraction_schemas.id"), nullable=False, index=True),
        ...
        sa.UniqueConstraint("schema_id", "field_name",
                            name="uq_extraction_fields_schema_field"),
    )
    ...
    op.create_table(
        ...
        sa.Column("field_id", UUID(as_uuid=True),
                  sa.ForeignKey("extraction_fields.id"), nullable=False, index=True),
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False,
                  server_default=sa.text("NOW()")),
        sa.UniqueConstraint("document_id", "field_id",
                            name="uq_extracted_values_doc_field"),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), server_default=sa.text("gen_random_uuid()"),
                  primary_key=True),
        sa.Column("document_id", UUID(as_uuid=True),
                  sa.ForeignKey("documents.id"), nullable=False, unique=True, index=True),
    ...
    op.create_table(
        ...
        sa.Column("job_id", UUID(as_uuid=True),
                  sa.ForeignKey("bulk_jobs.id"), nullable=False, index=True),
        sa.Column("document_id", UUID(as_uuid=True),
                  sa.ForeignKey("documents.id"), nullable=False, index=True),
        sa.Column("status", sa.String(20), nullable=False,
        ...
        sa.UniqueConstraint("job_id", "document_id",
                            name="uq_bulk_job_documents_job_doc"),
    )
    ...
    op.create_table(
        ...
        sa.Column("key_topics", JSONB(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("documents_discussed", JSONB(), nullable=False,
