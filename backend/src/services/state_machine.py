...
VALID_TRANSITIONS: dict[str, list[str]] = {
    ...
    "awaiting_parse_review": ["parsed", "edited", "processing"],
    "edited": ["classified", "summarized", "ingested", "processing"],
    "classified": [
        "classified",
        "extracted",
        "summarized",
    ...
    "awaiting_extraction_review": ["extracted", "processing"],
    "summarized": ["classified", "extracted", "summarized", "ingested", "processing"],
    "ingested": ["ingested"],
}
